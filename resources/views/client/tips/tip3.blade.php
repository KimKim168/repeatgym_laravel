...
@section('content')
<div class="flex justify-between py-12 px-4 mx-auto max-w-screen-xl ">
                <article class="mx-auto w-full max-w-7xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                    <header class="mb-4 lg:mb-6 not-format">
                        ...
                        <h1 class="mb-4 text-3xl leading-tight bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text lg:mb-6 lg:text-4xl dark:text-white">
                    ...
                    <p class="lead md:text-[16px]">In the mobile-first world we live in, having a mobile app is essential
                        ...
                        <ol class="list-decimal text-xl p-4 space-y-4">
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Custom
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">iOS
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Android
                                    App Development</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Cross-Platform
                                    App Development</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">UI/UX
                                    Design</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Mobile
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Enterprise
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">API
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">E-Commerce
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">App
                    ...
                    <div class="border-t">
                        ...
                        <ol class="list-decimal text-xl p-4 space-y-4">
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Discovery
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Design
                                    &amp; Prototyping:</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Development
                                    &amp; Testing:</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Launch
                                    &amp; Deployment:</strong>
                            ...
                            <li class="space-y-2">
                                <strong class="bg-gradient-to-r font-bold from-[#2d37a4] to-teal-500 text-transparent bg-clip-text md:text-xl ">Ongoing
